...
void main() {
  ...
  testWidgets(
    'integrations screen standalone route renders without provider black screen',
    (tester) async {
  ...
  testWidgets(
    'location reminder tab can create and manually trigger reminder',
    (tester) async {
      ...
      expect(
        notificationService.history.single.type,
