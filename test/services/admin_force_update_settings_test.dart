...
void main() {
  test('force update defaults use current 1.1.42 version floor', () {
    ...
    expect(pubspec, contains('version: 1.1.42+140008'));
    expect(appVersion, contains("static const name = '1.1.42';"));
    expect(appVersion, contains('static const build = 140008;'));
    expect(backend, contains('return "1.1.42", 140008'));
