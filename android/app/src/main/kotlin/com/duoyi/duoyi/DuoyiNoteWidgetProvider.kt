...
/** "随手记" 小组件。 */
open class DuoyiNoteWidgetProvider : DuoyiStyledWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds.forEach { id ->
            ...
            DuoyiWidgetTheme.applyContainer(
                ...
                views = views,
                prefs = prefs,
                rootId = R.id.widget_note_root,
                navId = R.id.widget_note_bottom_nav,
                appWidgetId = id,
            )
            DuoyiWidgetTheme.applyTextColors(
                ...
                mutedIds = intArrayOf(
                    ...
                    R.id.widget_note_nav_todo,
                    R.id.widget_note_nav_habit,
                    R.id.widget_note_nav_focus,
                ),
            )
            ...
            views.setOnClickPendingIntent(R.id.widget_note_title, openNote)
            views.setOnClickPendingIntent(R.id.widget_note_subtitle, openNote)
    ...
    companion object {
        ...
        fun requestUpdate(context: Context) {
            DuoyiWidgetProviderRegistry.requestUpdateForKind(context, "note")
        }
    }
}
