...
/** "纪念日" 小组件。 */
class DuoyiAnniversaryWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds.forEach { id ->
            ...
            views.setTextViewText(
                ...
                prefs.getString("memorial_highlight_1", "· 暂无近期纪念日") ?: "· 暂无近期纪念日"
            )
            views.setTextViewText(
                R.id.widget_anniversary_2,
                prefs.getString("memorial_highlight_2", "") ?: ""
            )
            views.setTextViewText(
                R.id.widget_anniversary_3,
                prefs.getString("memorial_highlight_3", "") ?: ""
            )
    ...
    companion object {
        ...
        fun requestUpdate(context: Context) {
            ...
            val ids = mgr.getAppWidgetIds(ComponentName(context, DuoyiAnniversaryWidgetProvider::class.java))
            if (ids.isNotEmpty()) {
                val intent = Intent(context, DuoyiAnniversaryWidgetProvider::class.java).apply {
