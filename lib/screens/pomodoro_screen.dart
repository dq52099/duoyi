                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _FocusRoomTile(
                      ...
                      compact: tight,
                      onTap: () =>
                          _showFocusRoomPicker(context, provider, roomProvider),
                    ),
...
class _FocusRoomTab extends StatelessWidget {
  const _FocusRoomTab();
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      roomProvider.loadFocusFriendsAndRanking();
      roomProvider.loadGlobalRanking();
