          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                const _WidgetPreviewCard.overview(),
                const SizedBox(height: 12),
                _WidgetCatalogTile(
...
class _WidgetPreviewCard extends StatelessWidget {
  ...
  const _WidgetPreviewCard.overview() : todoOnly = false;
  const _WidgetPreviewCard.todo() : todoOnly = true;
